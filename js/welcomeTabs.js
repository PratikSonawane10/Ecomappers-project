$(function (){
	...
	$("#addDeviceSubmit").on("click",function(){
		...
		$.post("http://localhost/EcomappersAPI/api/sensorDetails.php",data)
	...
	$.get("http://localhost/EcomappersAPI/api/sensorDetails.php?email="+email+"&method=loadDevice&format=json")
		.done(function (response){
